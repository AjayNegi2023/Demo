...
const Login = () => {
  ...
  if (authenticated && !check) {
    ...
    return (
      <div className="flex flex-col sm:flex-row justify-between bg-[#F5F5F5] items-center w-full">
        {/* Outer Container */}
        <div className="relative h-[940px] top-[24px] left-[32px] w-[704px] bg-gradient-to-tr from-[#8360C3] to-[#2EBF91] p-[32px]">
          {/* Inner Container */}
  ...
  <Logo className="mb-4" />
  <h2 className="text-white text-2xl md:text-4xl lg:text-5xl mt-4">
